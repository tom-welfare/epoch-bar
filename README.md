...
A tiny macOS menu-bar utility that converts Unix epoch timestamps on your
clipboard to UTC ISO 8601 dates.

Copy `1735689600` (or `1735689600.5`, or `1735689600500`, or
`1735689600500000`) to the clipboard; the menu bar title changes to
`⏱ 2025-01-01T00:00:00Z` within half a second. Left-click to copy the ISO
string; right-click for the app menu.
...
Values are accepted only if they fall between 2001-01-01 and 2099-12-31
UTC. This keeps random large integers from being misinterpreted as epochs.
